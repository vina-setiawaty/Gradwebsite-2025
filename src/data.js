const DESIGNER_DATA = [
    ...
    },
    {
        ...
        "Designer Photo 3:4": "",
        "Personal Description": "Jia Ying is a designer drawn to the subtleties of human experiences&#8212how people navigate decisions and adapt in unseen ways. Specializing in service design, she uncovers overlooked behaviors while balancing diverse needs. Having worked in constraint-driven environments such as healthcare, she understands their complexities yet seeks to challenge limitations to drive meaningful change.<br><br>With a background in visual arts, Jia Ying is attuned to quiet resilience&#8212the ways people persist, adapt, and find agency in adversity. This perspective shapes her approach, ensuring solutions that are not only functional but deeply resonate with those they serve. No matter the challenges ahead, she remains steadfast, committed to fighting for lasting impact.",
        "Icon Description": "My shape flows with quiet undulation - neither sharp nor static, but always shifting. As a generalist, I move across terrains with quiet strength and steady courage. There's softness here, but also resilience &#8212 a form that grows into openness.",
    ...
    },
    {
        ...
        "Designer Photo 3:4": "",
        "Personal Description": "Dawn is a designer driven by curiosity, empathy, and a commitment to enhancing user experiences through thoughtful research. With a background in graphic and experience design, she embraces an open-minded approach to uncovering unexpected insights that shape more intuitive and impactful solutions. Her design process is rooted in understanding people&#8212their needs, behaviors, and emotions&#8212ensuring that every interaction feels meaningful. <br><br>Beyond design, Dawn finds inspiration in indie music and books about life, always seeking new perspectives that enrich her creative thinking.",
    ...
    },
    {
        ...
        "Designer Photo 3:4": "",
        "Personal Description": "Design is serious business. Which is exactly why Zoey refuses to take it seriously. The most powerful ideas aren't the ones that blend in, but rather, they're the ones that make you do a double take, and leave you wondering why things are the way that they are. Because if something makes you stop and laugh, you'll never forget it.<br><br>Zoey designs with color, chaos, and fun, pushing back against the creeping weight of monotony.Whimsy is her way of reminding everyone that the world doesn't need more rules, it needs more fun.<br><br>Outside the studio, Zoey functions almost exclusively on coffee and freelances as an illustrator, branding, and graphic designer.",
    ...
    },
    {
        ...
        "Designer Photo 3:4": "",
        "Personal Description": "Eda is a designer who believes that small, thoughtful ideas can make a big difference. Through design, she has learned to notice what often goes unseen and to create with care. She's especially drawn to projects that make everyday life a little easier and more meaningful.<br><br>Outside of design, Eda spends a lot of time drawing fat cats, crocheting little things, and hanging out with loved ones. These personal routines often feed into her work, reminding her that design can be quiet and grounded. Not everything has to be bold to matter.<br><br>For her, design isn't about finding perfect solutions. It's about staying curious, paying attention, and making things that matter to someone.",
    ...
    },
    {
        ...
        "Designer Photo 3:4": "",
        "Personal Description": "Hi, I'm Hui Sin! Design makes me more observant, curious, and attuned to the little things people overlook. I'm drawn to where functionality, meaning, and exploration meet, where objects and experiences tell stories and spark conversations.  <br><br>I use design to challenge norms, reimagine everyday objects, and bring people together in unexpected ways. More than solving problems, I see design as a way to ask questions, reflect on behavior, and shape how we experience the world.",
    ...
    },
    {
        ...
        "Icon Description": "My shape represents a balance between playful creativity and simplicity, reflecting the way I approach design&#8212with a lightheartedness that sparks joy and invites meaningful connection.<br><br><br><br><br><br><br><br>",
    ...
    },
    {
        ...
        "Designer Photo 3:4": "",
        "Personal Description": "Hi, I'm Bing Jun. As an industrial designer, I enjoy proving myself wrong. <br><br>That means striving for constant self-improvement and daring to push boundaries. I am deeply interested in designing things that just feels right and simply works without needing an instruction manual. <br><br>To me, design is all about solving problems in an elegant manner that people never seem to take notice of, even when its obvious.",
        "Icon Description": "The future is shaped by those who ask, \u00e2\u20ac\u02dcWhat if?'. The negative circle in my shape symbolizes the limitless expansion of horizons into the unknown, grounded by a methodical yet bold approach that combines creative exploration with the grit to bring ideas to life.",
    ...
    },
    {
        ...
        "Designer Photo 3:4": "",
        "Personal Description": "Kai Xing once stared at an ordinary remote control and wondered&#8212what happens within the objects he interacts with every day? That curiosity led him to dismantle anything he could get his hands on, studying what goes into making a product. That moment shaped the way he approaches design and everyday interactions&#8212by uncovering what lies beyond the obvious, the intangible aspects of daily life.<br><br>A designer and a tinkerer at heart, Kai Xing is fascinated by the inner workings of everyday objects, often taking them apart, modifying, or even rebuilding them just to understand their mechanics. Whether it's repurposing discarded electronics, experimenting with materials, or refining everyday tools, he finds excitement in hands-on exploration. For him, design is not just about function and form&#8212it's about discovering new possibilities hidden within the familiar.",
    ...
    },
    {
        ...
        "Designer Photo 3:4": "",
        "Personal Description": "Jared sees design as a catalyst for different outcomes. He enjoys exploring various approaches and combining methods to produce novel results. He looks for patterns in strange experiments and constantly seeks fun, less serious ways to stay creative.<br><br>Aside from product design, he conducts research experiments, and sometimes graphic design finds him in unexpected ways. Outside of work, he writes stories and builds concepts for his personal world-building hobbies.<br><br>His dream is to travel and be inspired by different design styles around the world. This fuels his passion and joy for working with design.",
    ...
    },
    {
        ...
        "Designer Photo 3:4": "",
        "Personal Description": "Playful, fun and engaging, these are the things that intrigue Joshua when it comes to design. From playing with buildable toy blocks and board games as a kid, it developed into a hobby and passion in designing his own things of play like his own board games.<br><br>This passion also carries over to his designs, making places or products to be played with, to be appreciated, to be engaged with. He finds joy in bringing others joy and thus strives for excellence in his work, paying attention to the tiny details that make up the whole. <br><br>In his free time he also enjoys sculpting models or making miniatures. ",
    ...
    },
    {
        ...
        "Designer Photo 3:4": "",
        "Personal Description": "Min Xiang is a reflective and intentional thinker who seeks meaning in both life and design. He approaches the world with a quiet curiosity, valuing the slow, deliberate process of discovery. His design philosophy is rooted in hands-on experience, where making and reflecting are intertwined.<br><br>He finds beauty in the small, often overlooked moments&#8212capturing them through journaling and thoughtful observation. This meditative connection between hand and mind not only shapes his creative practice but also nurtures his personal growth and sense of consciousness.<br><br>Min Xiang's work reveals a person who designs not just to solve, but to understand, connect, and grow&#8212someone who sees design as a dialogue between the inner self and the external world.",
    ...
    },
    {
        ...
        "Designer Photo 3:4": "",
        "Personal Description": "From an early age, Kristy found comfort in video games, movies, and anime, and they have been her main sources of inspiration ever since.<br><br>To her, design is about seamlessly blurring the boundaries between reality and fantasy, where it is an invitation to experience a world where people can escape to. Creating designs that resonate deeply with both the heart and the senses.<br><br>Outside the world of design, she enjoys exploring the beauty industry and tinkering with custom mechanical keyboards.",
    ...
    },
    {
        ...
        "Designer Photo 3:4": "",
        "Personal Description": "When things feel disconnected and overwhelming, good design facilitates clarity, intuitive experiences, and genuine connections.<br><br>Suzie focuses on service design, UI/UX, and research, with a strong emphasis on understanding user behavior, simplifying complexity, and designing with empathy. She enjoys dissecting what makes a system work (or not) and finding ways to improve it for better experiences. This mindset has shaped her curiosity and perspective, allowing her to adapt to each unique challenge and craft solutions that are both functional and meaningful. The goal is always to create the best possible outcomes, regardless of the design medium.",
        "Icon Description": "My shape reflects the balance I seek in everything I do. It's about the coexistence of structure and fluidity, representing how I navigate between clarity and exploration, always adapting, always evolving.",
    ...
    },
    {
        ...
        "Designer Photo 3:4": "",
        "Personal Description": "Have you ever wondered too much...? Probing at existence, Rui Xuan toys with what can be observed, turning them into objects for conversation through design principles.<br><br>Her craft lies in creating stories for entities that exist in the periphery&#8212often fleeting&#8212giving them a platform to be seen, heard, and felt through design.<br><br>She seeks to connect with people through familiarity, using design as a medium to reframe and possibly relive the everyday.",
    ...
    },
    {
        ...
        "Designer Photo 3:4": "",
        "Personal Description": "The best designs don't just function well&#8212they evolve with their users.<br><br>Douglas thrives on uncovering the unseen&#8212bridging the gap between user, service experience, and product with a keen eye for context. By blending rigorous research with inventive experimentation, his multi-perspective approach uncovers hidden challenges and transforms them into opportunities for improvement. To him, the interweaving of various design disciplines are naturalistic and often reflects a real world perspective.<br><br>With a background in product design and photography, he brings together a wealth of experience from the appreciation and execution of visual arts, to a honed sensitivity towards the balance of form and function.",
        "Icon Description": "Douglas believes in design that uplifts &#8212 balanced, human, yet precise.",
    ...
    },
    {
        ...
        "Icon Description": "My shape represents who I am &#8212 a creative, fun and thoughtful person who brings passion for people into everything I do. ",
    ...
    },
    {
        ...
        "Designer Photo 3:4": "",
        "Personal Description": "Sophia's approach is deeply informed by her environment, drawing inspiration from personal artefacts tied to everyday rituals. Keen observation allows her to uncover subtle beauty and wonder in the ordinary, a sensibility that brings warmth to her work.<br><br>Sophia embraces a hands on, material led process, never afraid to get messy or dive into laborious work. Guided by mindfulness, her practice considers not just how objects are made, but how they are experienced. For her, the process of making is just as meaningful as the final outcome.",
        "Icon Description": "This fuzzy form is an ode to the things I love: soft, organic shapes with a hint of eccentricity. It's born from my affection for all things cute and full of character &#8212 a little odd, but always endearing. Like me, it doesn't take itself too seriously. ",
    ...
    },
    {
        ...
        "Designer Photo 3:4": "",
        "Personal Description": "Wesley is a designer who brings ideas to life.<br><br>He is deeply fascinated by cutting-edge technology and contemporary design. Through his design journey, he has developed a strong appreciation for the ability to connect the dots&#8212between concepts, people, and experiences. This approach allows him to create thoughtful and impactful work that resonates with others.<br><br>Design has become a way for Wesley to express ideas and emotions without boundaries. It has shaped the way he thinks, communicates, and solves problems. His passion lies in crafting products that leave a lasting impression and bring meaningful value to people.",
    ...
    },
    {
        ...
        "Designer Photo 3:4": "",
        "Personal Description": "Xin Yun is a designer with a keen interest in user experience and human behaviour. She enjoys understanding how people think and act, using these insights to create thoughtful and effective designs. Through various projects, she has sharpened her observational skills, allowing her to uncover patterns and translate them into meaningful solutions.<br><br>Her approach balances structure with creativity, focusing on clarity and ease of use. Xin Yun values adaptability and critical thinking, ensuring her designs are not only functional but also intuitive and engaging. She is committed to creating designs that feel natural and resonate with users.",
    ...
    },
    {
        ...
        "Designer Photo 3:4": "",
        "Personal Description": "Tze Yang enjoys conversing with people from all walks of life, honing a strong sense of empathy across his extensive interactions. Specializing in service design, he believes that this empathy, accompanied by some practicality, goes a long way in creating sustainable and effective solutions.<br><br>Believing in being an all-rounder, he hopes to develop himself in other areas of interest ranging from game development to photography. It is his fervent wish to continue making meaningful connections, to continue to apply his craft, and to continue learning from others.",
    ...
    },
    {
        ...
        "Designer Photo 3:4": "",
        "Personal Description": "He Kai is a designer who loves complexity, imaginary problems and new spaces. This currently intersects nicely with design about technology and interaction, where new toys emerge bi-daily, and he tries to reconcile this with his passion for crafts and making.<br><br>For He Kai, making is a game about spinning disparate elements into each other, forming spicy connections into conclusions that can withstand rigorous objective critique. Whether harmonious or dissonant, the goal is a cohesive use experience that approaches inevitability.<br><br>He enjoys shaping materials, experiences, and objects, anything with tight iteration cycles, often blurring all three; He hopes his designs feel natural.",
